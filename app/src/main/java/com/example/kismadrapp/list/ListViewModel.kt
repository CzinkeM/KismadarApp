...
class ListViewModel(context: Context, fragmentManager: FragmentManager):ViewModel() {
    ...
    private val imgRestaurant = ResourcesCompat.getDrawable(context.resources,R.drawable.vector_food,null)!!
    private val imgNature = ResourcesCompat.getDrawable(context.resources,R.drawable.vector_trip,null)!!
    private val imgService = ResourcesCompat.getDrawable(context.resources,R.drawable.vector_services,null)!!
    private val imgShop = ResourcesCompat.getDrawable(context.resources,R.drawable.vector_shop,null)!!
    private val imgSight = ResourcesCompat.getDrawable(context.resources,R.drawable.vector_travellers,null)!!
    //Models
    ...
    //Lists
    private val restaurantList = arrayListOf<CategoryModel>(testRestaurant,testRestaurant,testRestaurant,testRestaurant,testRestaurant,testRestaurant,testRestaurant,testRestaurant,testRestaurant)
    private val natureList = arrayListOf<CategoryModel>(testNature,testNature,testNature,testNature,testNature,testNature,testNature)
    private val serviceList = arrayListOf<CategoryModel>(testService,testService,testService,testService,testService,testService,testService,testService,testService)
    private val shopList = arrayListOf<CategoryModel>(testShop,testShop,testShop,testShop,testShop,testShop,testShop,testShop,testShop,testShop,testShop,testShop,testShop)
    private val sightList = arrayListOf<CategoryModel>(testSight,testSight,testSight,testSight,testSight,testSight,testSight,testSight,testSight,testSight,testSight,testSight)
    ...
    fun setAdapter(categoryName: String): RecyclerView.Adapter<RecyclerView.ViewHolder>
    {
        ...
        when(categoryName)
        {
            ...
            viewModelContext.getString(R.string.category_surroundings) -> list = getListOfTowns(viewModelContext.resources) as ArrayList<CategoryModel>
